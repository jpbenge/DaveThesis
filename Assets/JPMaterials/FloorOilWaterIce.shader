...
////// Specular:
                ...
                float3 specularColor = lerp(lerp(lerp(_BaseSpec_var.rgb,lerp((floor((1.0 - _OilDiffuse_var.rgb))*(texCUBE(_OilIridescence,viewReflectDirection).rgb*_OilPower)),_OilDiffuse_var.rgb,_OilDiffuse_var.b),_Oil),_IceSpec_var.rgb,_Ice),_WaterSpec_var.rgb,_Water);
...
/// Final Color:
    ...
    FallBack "Shader Forge/FloorOilWaterIce_Fallback"
